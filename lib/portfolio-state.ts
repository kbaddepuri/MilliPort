...
export const initialRecommendations: Recommendation[] = [
  ...
  { id: "rec-poet-buy-400", ticker: "POET", action: "BUY", amount: 400, thesis: "Asymmetric optical-interconnect opportunity; high execution risk.", status: "PENDING", createdAt: "2026-09-09T00:00:00.000Z" },
  { id: "rec-smci-buy-700", ticker: "SMCI", action: "BUY", amount: 700, thesis: "AI-server demand and operating leverage create upside, with margin risk.", status: "PENDING", createdAt: "2026-09-09T00:00:00.000Z" },
  { id: "rec-sndk-buy-500", ticker: "SNDK", action: "BUY", amount: 500, thesis: "AI storage and memory-cycle leverage; size additions carefully.", status: "PENDING", createdAt: "2026-09-09T00:00:00.000Z" },
];
